...
function add_connection_establishment_arguments(yargs) {
  yargs
    ...
    .option("ca_file", {
      alias: "r",
      description:
        "File path to a Root CA certificate file in PEM format.",
      type: "string",
      required: false,
    })
    .option("cert", {
    ...
    .option("use_websocket", {
      ...
      default: false,
      description:
        "To use a websocket instead of raw mqtt. If you specify this option you must set a region " +
    ...
    .option("verbosity", {
      alias: "v",
      description:
        "The amount of detail in the logging output of the sample.",
      type: "string",
      default: "none",
      choices: [
        "fatal",
...
exports.build_connection_from_cli_args =
  build_connection_from_cli_args;

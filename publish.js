...
const common_args = require("C:\\Users\\pogliani.mattia\\Documents\\5BI\\backendApiIot\\util\\cli_args.js");
...
yargs
  .command(
    ...
    false,
    (yargs) => {
      common_args.add_connection_establishment_arguments(
        yargs
      );
...
async function main(argv) {
  console.log("bellazio", argv);
  common_args.apply_sample_arguments(argv);

  const connection =
    common_args.build_connection_from_cli_args(argv);
